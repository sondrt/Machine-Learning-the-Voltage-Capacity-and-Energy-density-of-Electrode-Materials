...
#                print("vol: ",volume0,nel)
                #print ( 'kkk=', data[el+'_vol'][iqid])
                # try:
                #   if 
                #   print(data[el "_vol"])
                # except:
                #   print("F you, I won't do what you told me!")

              #  data[mid][el + '_vol'] = normVol
                
#                if data[mid][el + '_vol'] == 0:
#                  print("kremt")
#             AllElements.append(elements0[iel])

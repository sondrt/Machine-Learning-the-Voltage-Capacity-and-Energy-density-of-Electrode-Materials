...
% 	\subsubsection{The basics}\label{sec:introexample}
	As an introduction on how Machine Learning was applied to learn and recognize patterns in our work, it's useful to start with a simple example applied to the recognition of the handwritten number "5". 

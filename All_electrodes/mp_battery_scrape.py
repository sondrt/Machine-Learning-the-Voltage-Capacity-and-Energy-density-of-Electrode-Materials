...
#
# 0.
# Scrape batteries with a given working ion 
# from the Materials Project battery explorer(https://www.materialsproject.org/#search/batteries)
#
#-----------------------------------------------------------------------------------------------------
...
#atomtypes = ['Li','Mg','Ca','Y','Na','Al','Zn','K','Cs', 'Rb'] 
atomtypes = ['Rb']
for i in atomtypes:
    ...
    if path.exists(filename):
        print('File already exists, trying with next atomtype')
    else:    
